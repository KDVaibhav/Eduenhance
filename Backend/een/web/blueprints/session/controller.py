...
from een.web.app.sockets import disconnect_socket
...
class SessionController:
    ...
    def index(self, session_id, user):
        ...
        :param user User"""
        session_doc = sessions(getSchool()).get(session_id)
        ...
        proposal_docs = proposals(getSchool()).find({"_id": {"$in": session_doc.proposals}})
        proposal_map = {
